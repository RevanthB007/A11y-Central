            ...
            <div className="px-6 py-4 border-b border-gray-700">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-400 mt-1">
                    Analyzed {linkStatus.summary?.totalLinks || 0} links and {linkStatus.summary?.totalImages || 0} images
                  </p>
                </div>
                <div className={`text-2xl font-bold ${linkStatus.summary?.healthScore >= 90 ? 'text-green-400' :
                    linkStatus.summary?.healthScore >= 70 ? 'text-orange-400' : 'text-red-400'
                  }`}>
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="p-4 rounded border bg-green-900/20 border-green-500/30">
                  ...
                  <div className="text-2xl font-bold text-green-400">
                    {(linkStatus.summary?.totalLinks || 0) - (linkStatus.summary?.brokenLinks || 0)}
                  </div>
                </div>
                ...
                <div className="p-4 rounded border bg-blue-900/20 border-blue-500/30">
                  ...
                  <div className="text-2xl font-bold text-blue-400">
                    {(linkStatus.summary?.totalLinks || 0) + (linkStatus.summary?.totalImages || 0)}
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="text-center p-3 bg-gray-800/30 rounded border border-gray-600">
                  <div className="text-xl font-bold text-purple-300">{linkStatus.summary?.externalLinks || 0}</div>
                  <div className="text-xs text-gray-400 flex items-center justify-center gap-1">
                    <ExternalLink className="w-3 h-3" />
                    External Links
                  </div>
                ...
                <div className="text-center p-3 bg-gray-800/30 rounded border border-gray-600">
                  <div className="text-xl font-bold text-pink-300">{linkStatus.summary?.socialLinks || 0}</div>
                  <div className="text-xs text-gray-400 flex items-center justify-center gap-1">
                ...
                <div className="text-center p-3 bg-gray-800/30 rounded border border-gray-600">
                  <div className="text-xl font-bold text-yellow-300">{linkStatus.summary?.totalImages || 0}</div>
                  <div className="text-xs text-gray-400 flex items-center justify-center gap-1">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 max-h-96 overflow-y-auto">
                      {displayedInternal.map((link, index) => (
                        <div key={index} className="p-4 rounded border bg-red-900/20 border-red-500/30">
                          <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="text-sm text-red-200/80 mb-2">{link.error}</div>
                          <div className="flex justify-between items-center text-xs text-gray-400">
                            <span>Found on: {link.foundOn}</span>
                            {link.responseTime && <span>{link.responseTime}ms</span>}
                          </div>
                        </div>
                      ))}
                      {linkStatus.brokenInternal.length > 5 && (
                        ...
                        >
                          {showAllInternal ? (
                            ...
                            <>Show {linkStatus.brokenInternal.length - 5} More <Eye className="w-3 h-3" /></>
                          )}
                        </button>
                      )}
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 max-h-96 overflow-y-auto">
                      {displayedExternal.map((link, index) => (
                        <div key={index} className="p-4 rounded border bg-orange-900/20 border-orange-500/30">
                          <div className="flex justify-between items-start mb-2">
                            <div className="flex-1 mr-4">
                          ...
                          <div className="text-sm text-orange-200/80 mb-2">{link.error}</div>
                          <div className="flex justify-between items-center text-xs text-gray-400">
                            <span>Found on: {link.foundOn}</span>
                            {link.responseTime && <span>{link.responseTime}ms</span>}
                          </div>
                      ...
                      {linkStatus.brokenExternal.length > 5 && (
                        ...
                        >
                          {showAllExternal ? (
                            ...
                            <>Show {linkStatus.brokenExternal.length - 5} More <Eye className="w-3 h-3" /></>
                          )}
                        </button>
                      )}
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 max-h-96 overflow-y-auto">
                      {displayedImages.map((image, index) => (
                        <div key={index} className="p-4 rounded border bg-yellow-900/20 border-yellow-500/30">
                          <div className="flex justify-between items-start mb-2">
                            <div className="flex-1 mr-4">
                          ...
                          <div className="text-sm text-yellow-200/80 mb-2">{image.error}</div>
                          <div className="flex justify-between items-center text-xs text-gray-400">
                            <span>Found on: {image.foundOn}</span>
                            {image.responseTime && <span>{image.responseTime}ms</span>}
                          </div>
                        </div>
                      ))}
                      {linkStatus.brokenImages.length > 5 && (
                        ...
                        >
                          {showAllImages ? (
                            ...
                            <>Show {linkStatus.brokenImages.length - 5} More <Eye className="w-3 h-3" /></>
                          )}
                        </button>
                      )}
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 max-h-96 overflow-y-auto">
                      {displayedSlow.map((link, index) => (
                        <div key={index} className="p-4 rounded border bg-orange-900/10 border-orange-500/20">
                          <div className="flex justify-between items-start mb-2">
                            <div className="flex-1 mr-4">
                              <div className="font-mono text-sm text-orange-200 break-all mb-1">
                                {link.href}
                          ...
                          <div className="text-sm text-orange-200/80 mb-2">{link.warning}</div>
                          <div className="text-xs text-gray-400">
                      ...
                      {linkStatus.slowLinks.length > 5 && (
                        ...
                        >
                          {showAllSlow ? (
                            ...
                            <>Show {linkStatus.slowLinks.length - 5} More <Eye className="w-3 h-3" /></>
                          )}
                        </button>
                      )}
                    </div>
              ...
              {linkStatus.summary &&
                ...
                linkStatus.summary.totalLinks > 0 && (
                  <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-6 text-center">
                    ...
                    <p className="text-green-200">
                      Checked {linkStatus.summary.totalLinks} links and {linkStatus.summary.totalImages} images - no broken links found.
                    </p>
                  </div>
                )}
